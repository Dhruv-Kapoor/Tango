...
fun ZipActivityView(
    ...
    viewModel: ZipActivityViewModel = viewModel {
        ZipActivityViewModel(preview = true)
    },
    started: Boolean = true,
    loading: Boolean = false,
    isLoggedIn: Boolean = false,
    completed: Boolean = false,
    grid: Array<Array<ZipCellData>>? = arrayOf(),
...
fun ZipActivity(
    ...
    val viewModel: ZipActivityViewModel = viewModel()
